---
title: Office Web Apps Server 的 Windows PowerShell
TOCTitle: Office Web Apps Server 的 Windows PowerShell
ms:assetid: 56bfd3b3-f563-423d-aea0-65b331f73b96
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Ee890080(v=office.15)
ms:contentKeyID: 49565104
ms.date: 01/03/2018
mtps_version: v=office.15
ms.translationtype: HT
---

# Office Web Apps Server 的 Windows PowerShell
...
**摘要：**尋找用來設定 Office Web Apps Server 之 OfficeWebApps Windows PowerShell Cmdlet 的相關文章。

**對象：**IT 專業人員

Office Web Apps Server 是新的 Office 伺服器產品，提供瀏覽器型版本的 Word、PowerPoint、Excel 和 OneNote。單一 Office Web Apps Server 伺服器陣列可支援透過 SharePoint 2013、Lync Server 2013、Exchange Server 2013、共用資料夾和網站來存取 Office 檔案的使用者。

![Office 2013 標誌](images/JJ219447.a106e261-2cd0-43b7-af77-92de7e4b6fb9(Office.15).png "Office 2013 標誌")下表列出並說明適用 Office Web Apps Server 之每個 OfficeWebApps Windows PowerShell Cmdlet 的文章。
...
<tbody>
<tr class="odd">
<td>如果當您執行這些 Cmdlet 時 Windows PowerShell 無法辨識它們，您可能需要匯入 <strong>OfficeWebApps</strong> 模組。請使用下列命令：<br />
...
<td><p>若要提供針對 Office 2013Office 365 專業增強版 文件的意見，請選擇頁面底端的 [意見反應] 連結。如此會將您的意見反應直接傳送給文件小組。</p>
