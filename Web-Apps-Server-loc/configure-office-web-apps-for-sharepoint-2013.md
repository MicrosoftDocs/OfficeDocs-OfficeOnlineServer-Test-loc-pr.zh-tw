...
在開始進行下列程序前，請確定您已按照＜[部署使用 HTTPS 的單一伺服器 Office Web Apps Server 陣列](deploy-office-web-apps-server.md)＞或＜[部署使用 HTTPS 的多伺服器、負載平衡 Office Web Apps Server 伺服器陣列](deploy-office-web-apps-server.md)＞中的步驟設定 Office Web Apps Server。
